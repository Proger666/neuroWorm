...
README
====================================================================================================
Questa applicazione   un simulatore java del pacchetto NEAT , sviluppato
da Kenneth Stanley;
E' stato testato sia in ambiente linux , red-hat 7.2 , sia in ambiente windows , win200,win98;
Non sono necessarie classpath e il solo requisito   il JDK 1.3.1_01 di Sun o
il JDK 1.2.2 di IBM;
In questo documento   incluso in piccolo esempio per la simulazione della rete
...
Note:
1) In linux    stata usata l'authority 'root' per usare i comandi :  compile, run, compilall
...
Tale classe   ormai obsoleta e potr  essere tolta in futuro
